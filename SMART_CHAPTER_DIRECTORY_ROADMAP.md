...
- [x] แสดง `เหตุผลที่ Match` บนทุกผลลัพธ์
- [x] แยกผลลัพธ์ `Referral พร้อม` และ `สมาชิกทั้งหมด`
- [x] จัดสมาชิกที่เปิดแชร์และข้อมูลสมบูรณ์ไว้ก่อน
- [x] แสดง Referral Readiness โดยไม่ใช้เป็น Ranking สาธารณะ
- [x] แสดงวันที่อัปเดต Referral Focus ล่าสุด
- [x] เพิ่ม `บันทึกไว้` และหน้ารายการที่สมาชิกบันทึก
- [x] ปรับการ์ด Mobile ให้สแกนได้เร็วและปุ่มสัมผัสไม่น้อยกว่า 44px
- [x] เพิ่ม Empty, Loading, Error, Offline และ No-consent states
- [ ] รองรับคำค้นภาษาไทยที่มีเว้นวรรค/รูปแบบใกล้เคียง
- [x] เพิ่ม Event แบบไม่เก็บเนื้อหาส่วนตัว: search, result open, bookmark
- [x] เพิ่มการ์ดเตือนวัน Review สำหรับ Chapter Admin ใน MC Desktop โดยอ่าน Phase/วันที่จากการตั้งค่ากลางและไม่ส่ง LINE อัตโนมัติ
