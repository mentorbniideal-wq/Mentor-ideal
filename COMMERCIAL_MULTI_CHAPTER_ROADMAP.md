...
#### Member-requested verification recovery (10 กันยายน 2569)

- หน้า MY121 มีปุ่มโหลดรหัสเดิมอีกครั้งและแจ้งปัญหารหัส/ขอรีเซ็ต พร้อมสถานะคำขอที่กลับมาเปิดดูได้
- Backend ตรวจ LINE identity และสมาชิกในคู่ก่อนอ่าน/บันทึกคำขอ; client ระบุผู้รับหรือผู้แจ้งเองไม่ได้
- ใช้ Attention Queue เดิมและ unique idempotency key จากคู่ + รุ่นรหัส เพื่อให้คู่ 2 คนหรือกลุ่ม 3 คนมีคำขอเดียวต่อรุ่น ไม่มีรหัส/hash แนบไปกับคำขอ
- การขอไม่รีเซ็ตเอง; Admin/Mentor Co. เปิดจัดการคู่และยืนยันผลกระทบก่อนใช้ขั้นตอนรีเซ็ตเดิม เมื่อเสร็จปิดคำขอของรุ่นเก่า โดยไม่ปิดคำขอใหม่ที่เกิดหลังรีเซ็ต
- คิวเป็นหลักฐานถาวรของผู้ขอและเวลา; ใช้การแจ้ง Mentor/MC เดิม ผู้ใช้เห็นคำเตือนหากบันทึกแล้วแต่การส่งแจ้งเตือนล้มเหลว
- Technical debt: Attention Queue เดิมยังอิง stable pair IDs และ active installation; Phase 2 ต้อง backfill Chapter scope และทดสอบ tenant isolation ตาม roadmap การเปลี่ยนแปลงนี้ไม่เริ่ม Token migration
